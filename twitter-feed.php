<?php
/**
 * The template part for displaying tweets
 *
 * Move this into your theme and call using get_template_part();
 *
 */
?>


<div class="custom_twitter_feed">
<?php $tweets = get_tweets( 'qumulo', 3 ); ?>
<?php if ( $tweets ) : ?>
	<?php foreach ( $tweets as $tweet ) : ?>
		<div class="tweets">
			<!-- <img alt="<?php echo $tweet->user->name; ?>" src="<?php echo $tweet->user->profile_image_url; ?>"> -->
			<p><?php echo qumulo_link_tweets( $tweet->text ); ?></p>
            <div class="tweet_meta">
                <a class="tweet_reply" href="https://twitter.com/intent/tweet?in_reply_to=<?php echo $tweet->id_str; ?>">
                ...
                <a class="tweet_retweet" href="https://twitter.com/intent/retweet?tweet_id=<?php echo $tweet->id_str; ?>">
                ...
                <a class="tweet_like" href="https://twitter.com/intent/like?tweet_id=<?php echo $tweet->id_str; ?>">
                ...
                <a class="tweet_time" href="https://twitter.com/qumulo/status/<?php echo $tweet->id_str; ?>" target="_blank">
                    <?php echo time2str(strtotime($tweet->created_at)); ?>
                </a>
            </div>
		</div>
	<?php endforeach; ?>
